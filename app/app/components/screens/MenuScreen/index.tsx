...
type Props = {categories: MenuCategory[]; selectedCategory: string; onCategoryChange: (category: string) => void; search: string; onSearchChange: (value: string) => void; sections: MenuSection[]; dietaryTags: Record<string, string[]>; dietaryTagNames: Record<string, string>; allergenTags?: Record<string, string[]>; allergenTagNames?: Record<string, string>; allergenTagStyles?: Record<string, AllergenTagStyle>; outOfStockItems: Set<string>; courseOffer?: CourseOffer; onBuildCourseMenu: () => void; itemOptions: Record<string, ItemOptionSet>; onPromptItemOptions: (item: string) => void; orderAheadBooking: {guests: string; time: string} | null; serviceLabel?: string; onAdd: (name: string) => void; onBook: () => void};
