...
export function IphoneContainer({apps, dockApps = [], initialAppId = null, notification = null, onDismissNotification, onClock = () => undefined, onAppOpenChange = () => undefined, isDark = false, isLandscape = false, isThreeD = false, caseColor, device, className = ''}: {
    ...
    const systemIconBackgrounds: Record<string, string> = {Calendar: 'linear-gradient(145deg,var(--qt-color-fb6974),var(--qt-color-b70e27))', Photos: 'linear-gradient(145deg,var(--qt-color-ff6b78),var(--qt-color-7754c6))', Music: 'linear-gradient(145deg,var(--qt-color-ff7a68),var(--qt-color-8b4bd2))', Maps: 'linear-gradient(145deg,var(--qt-color-64d1f4),var(--qt-color-2866c8))', Weather: 'linear-gradient(145deg,var(--qt-color-69bcff),var(--qt-color-5147bd))', Notes: 'linear-gradient(145deg,var(--qt-color-ffe066),var(--qt-color-e77820))'};
    const dockIconBackgrounds: Record<string, string> = {Phone: 'linear-gradient(145deg,var(--qt-color-70df74),var(--qt-color-18a844))', Messages: 'linear-gradient(145deg,var(--qt-color-5cc8ff),var(--qt-color-1664d5))', Safari: 'linear-gradient(145deg,var(--qt-color-72caff),var(--qt-color-2f5ebb))', Camera: 'linear-gradient(145deg,var(--qt-color-ios-icon-grey),var(--qt-color-121217))'};
